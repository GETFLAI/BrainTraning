...
public class Lvl4TextActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lvl4_text);
        ...
        btNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                buttonSound.start();
                Intent intent = new Intent(Lvl4TextActivity.this, Lvl4TaskActivity.class);
