...
public class Lvl7TaskActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lvl7_task);
        ...
        btNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                buttonSound.start();
                Intent intent = new Intent(Lvl7TaskActivity.this, MenuActivity.class);
        ...
        Bitmap[][] res = BitmapMosaicUtil.sliceBitmap(((BitmapDrawable)getDrawable(R.drawable.mozaika4)).getBitmap(), 3, 3);
        ...
        View.OnClickListener onImageClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(
                    ...
                    AlertDialog.Builder b = new AlertDialog.Builder(Lvl7TaskActivity.this);
                    b.setTitle("Поздравляем!");
                    b.setMessage("Вы прошли седьмой уровень!");
