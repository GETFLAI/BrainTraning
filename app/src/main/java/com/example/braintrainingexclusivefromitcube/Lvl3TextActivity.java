...
public class Lvl3TextActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lvl3_text);
        ...
        btNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                buttonSound.start();
                Intent intent = new Intent(Lvl3TextActivity.this, Lvl3TaskActivity.class);
