...
public class Lvl2TextActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lvl2_text);
        ...
        btNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                buttonSound.start();
                Intent intent = new Intent(Lvl2TextActivity.this, Lvl2TaskActivity.class);
