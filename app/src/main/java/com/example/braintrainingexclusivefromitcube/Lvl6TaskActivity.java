...
public class Lvl6TaskActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lvl6_task);
        ...
        btNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                buttonSound.start();
                Intent intent = new Intent(Lvl6TaskActivity.this, MenuActivity.class);
                startActivity(intent);
            }
        });

        if(vopros2.getText().toString().toLowerCase().equals("зубы")){
            AlertDialog.Builder b = new AlertDialog.Builder(Lvl6TaskActivity.this);
            b.setTitle("Поздравляем!");
            b.setMessage("Вы прошли шестой уровень!");
