...
public class Lvl5TextActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lvl5_text);
        ...
        btNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                buttonSound.start();
                Intent intent = new Intent(Lvl5TextActivity.this, Lvl5TaskActivity.class);
