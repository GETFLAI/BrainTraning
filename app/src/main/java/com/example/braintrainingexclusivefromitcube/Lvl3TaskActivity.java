...
public class Lvl3TaskActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lvl3_task);
        ...
        btNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                buttonSound.start();
                Intent intent = new Intent(Lvl3TaskActivity.this, MenuActivity.class);
                startActivity(intent);
            }
        });

        if(vopros2.getText().toString().toLowerCase().equals("песок")){
            AlertDialog.Builder b = new AlertDialog.Builder(Lvl3TaskActivity.this);
            b.setTitle("Поздравляем!");
            b.setMessage("Вы прошли третий уровень!");
