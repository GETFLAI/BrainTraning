...
public class Lvl4_1Activity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lvl4_1);

        //создаём связку уровень 4 - меню
        //инициализируем переменную звука кнопки
        buttonSound = MediaPlayer.create(this, R.raw.button);
        //создаём обработчик кнопки
        Button buttonGoMenu4 = (Button) findViewById(R.id.buttonGoMenu4);
        //создаем кнопкe обработчик
        buttonGoMenu4.setOnClickListener(new View.OnClickListener() {
            //создаем выход обратно
            @Override
            public void onClick(View view) {
                buttonSound.start();
                Intent intent = new Intent(Lvl4_1Activity.this, MenuActivity.class);
        ...
        View.OnClickListener onImageClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(
                    ...
                    Toast.makeText(Lvl4_1Activity.this, "grrtgh", Toast.LENGTH_SHORT).show();
